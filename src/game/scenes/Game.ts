...
import { Controls, driveWyverns } from '../game_objects/wyvernDriver';
...
export class Game extends Scene {
    ...
    create () {
        ...
        this.systemUpdates.push(driveWyverns);
        ...
        const obj = wyverns[0];
        addEC(this.world, obj.eid, Controls, createInputControls(this.input.keyboard!));
